...
const forecast = (lat, lon, callback)=>{
    ...
    //    console.log(response.body) //debugger
        if (error){
             ...
             callback(undefined, body.current.weather_descriptions +'. It is currently ' + body.current.temperature + ' degrees out' + '. ' + 'There is ' + body.current.feelslike + '%' + ' chance of rain.' + "Is it day?: " + body.current.is_day + ".");
        };
    });
};
